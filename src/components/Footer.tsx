...
const Footer = ({ navigate }: FooterProps) => (
  <footer className="mt-4 border-t border-neutral-800/10 py-7 text-[10px] uppercase tracking-[0.15em] text-neutral-500">
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <span>© 2026 Stilte &amp; Draad · door <a href="https://www.innerversestudio.nl/" target="_blank" rel="noreferrer" className="hover:text-neutral-900">innerverse studio</a></span>
