...
export const editorialZones: Record<'de-eerste-draad' | 'veld' | 'droom' | 'ritueel' | 'stilte', EditorialZone> = {
  ...
  droom: {
    eyebrow: 'De binnenwereld', title: 'Droom', question: 'Wat probeert vorm te krijgen?', coreLine: 'Sommige werken bestaan al voordat ik ze maak.', introduction: 'Ik ben een dromenvanger. Niet omdat iedere droom uitkomt, maar omdat dromen mij in beweging houden. Ik blijf niet alleen hopen; ik zet een stap, pak een draad en geef het onzichtbare langzaam een vorm.', heroImage: '/photos/droom-jannie.jpg', heroImageWebp: '/photos/droom-jannie.webp', heroAlt: 'Handen die aan een houten tafel een lichte draad boven een rond haakwerk laten bewegen',
