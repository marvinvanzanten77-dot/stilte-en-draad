...
const entries: ProductEntry[] = [
  ...
  { id: 3, title: 'Vrije Lucht', category: 'Wandwerken', description: 'Blauwe en witte draden vormen een open cirkel met lange kwasten, als lucht die vrij door het werk heen kan bewegen.', price: 45 },
  ...
  { id: 7, title: 'Onbezorgd', category: 'Wandwerken', description: 'Een zachtroze draadwerk met rijen gekleurde kralen, speels en licht als een gedachte die nergens naartoe hoeft.', price: 25 },
  ...
  { id: 13, title: 'Onbezorgd II', category: 'Wandwerken', description: 'Witte draden dalen vanaf een gebogen tak langs houten kralen en zachte kwasten, rustig en vrij in hun eigen ritme.', price: 75 },
  { id: 14, title: 'Aan de Tak', category: 'Wandwerken', description: 'Hout, draad en kralen vormen samen een rustige lijn tussen natuur en handwerk.', price: 20 },
...
const productUpdates: Record<number, Partial<Product>> = {
  ...
  14: { readiness: 'purchasable', diameterCm: 16, materials: ['katoen'], depthNotApplicable: true, careInstructions: 'Uitsluitend bestemd voor gebruik binnenshuis.' },
