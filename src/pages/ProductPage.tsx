  ...
  return (
    <div className="space-y-7">
      ...
      {!certificate && <div className="grid gap-4 md:grid-cols-2">
        <section className="rounded-xl border border-neutral-800/10 bg-white/25 p-5 text-xs leading-6 text-neutral-600"><h2 className="font-semibold uppercase tracking-[0.14em] text-neutral-700">Ontvangst van het werk</h2><p className="mt-2">Je haalt het werk op afspraak op in IJzendoorn, doorgaans binnen twee tot vijf werkdagen. Na je bestelling nemen we persoonlijk contact met je op om een geschikt moment af te spreken.</p></section>
