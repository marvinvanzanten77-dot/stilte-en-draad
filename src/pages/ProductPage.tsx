  ...
  return (
    <div className="space-y-7">
      ...
      {!certificate && <div className="grid gap-4 md:grid-cols-2">
        <section className="rounded-xl border border-neutral-800/10 bg-white/25 p-5 text-xs leading-6 text-neutral-600"><h2 className="font-semibold uppercase tracking-[0.14em] text-neutral-700">Ontvangst van het werk</h2><p className="mt-2">{product.pickupAllowed ? product.deliveryTime : 'De mogelijkheden voor ontvangst worden vóór bestellen duidelijk vermeld.'}</p>{!product.shippingAllowed && <p className="mt-2">Verzending is voor dit werk nog niet aangeboden. Zo voorkomen we dat een uniek of kwetsbaar werk zonder passende verpakking onderweg gaat.</p>}</section>
